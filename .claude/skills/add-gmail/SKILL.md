...
> - Triggered only from WhatsApp (e.g., "@Qorin check my email" or "@Qorin send an email to...")
...
>
> `@Qorin check my recent emails`
>
> Or:
>
> `@Qorin list my Gmail labels`
...
> - Emails with a subject starting with a keyword (e.g., "[Qorin]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Qorin check my recent emails`.
